...
JavascriptExecutor executer =((JavascriptExecutor) getDriver());
executer.executeScript("argument[0].value='"+ value + "';", ele);
}
public void clearTextUsingSendKesys(WebElement toClear) {
